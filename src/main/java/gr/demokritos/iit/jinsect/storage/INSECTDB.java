...
public abstract class INSECTDB<TObjectType extends Serializable> {
	...
	/* Object and category types */
	public static String CATEGORY_TYPE = "Category";
	public static String DOCUMENT_TYPE = "Document";

	/** 
	 * Creates a new instance of INSECTDB 
	 */
	public INSECTDB() {}    

	/** 
	 * Finalizes db.
	 * Descendants should perform finalization operations in this
	 * member. */
	 ...
	 * @param sObjectName The name (and unique identifier within the category) 
	 * of the object.
	 ...
	 * of the object.
	 * @param sObjectCategory The category of the saved object.
	 * @return <tt>true</tt> if the object exists, otherwise <tt>false</tt>
	 */
	 ...
	 * @return A String array, with all the saved objects corresponding to
	 * the given category.
	 */
